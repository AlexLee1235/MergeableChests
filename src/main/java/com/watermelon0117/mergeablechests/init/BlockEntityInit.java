...
public class BlockEntityInit {
    ...
    public static final RegistryObject<BlockEntityType<IntersectBlockEntity>> INTERSECT_BE = BLOCK_ENTITIES.register("intersect",
            () -> BlockEntityType.Builder.of(IntersectBlockEntity::new, BlockInit.INTERSECT.get()).build(null));
