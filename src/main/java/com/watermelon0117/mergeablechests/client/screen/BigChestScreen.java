...
public class BigChestScreen extends AbstractContainerScreen<BigChestMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        guiGraphics.blit(CONTAINER_BACKGROUND, leftPos, topPos, 0, 0, imageWidth, chestAreaHeight);
        guiGraphics.blit(CONTAINER_BACKGROUND, leftPos, topPos + chestAreaHeight, 0, 126, imageWidth, 96);
    ...
    private void renderScrollBar(GuiGraphics guiGraphics) {
        ...
        guiGraphics.fill(trackX, trackY, trackX + SCROLL_TRACK_WIDTH, trackY + SCROLL_TRACK_HEIGHT, 0x66000000);

        int thumbY = getThumbY();
        guiGraphics.fill(trackX, thumbY, trackX + SCROLL_TRACK_WIDTH, thumbY + SCROLL_THUMB_HEIGHT, 0xFFE0E0E0);
        guiGraphics.fill(trackX + 1, thumbY + 1, trackX + SCROLL_TRACK_WIDTH - 1, thumbY + SCROLL_THUMB_HEIGHT - 1, 0xFF8A8A8A);
    }
